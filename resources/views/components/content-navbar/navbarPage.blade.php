...
<nav class="bg-white px-4 md:px-20 py-2 flex items-center justify-between flex-wrap" x-data="{ open: false }">
    <!-- Left: Logo -->
    ...
    <button @click="open = !open" class="text-2xl text-textprimary md:hidden ml-auto">
     ...
     {{-- Seart Box --}}
    <div class="hidden bg-[#F0F0F0] px-[30px] py-[15px] rounded-2xl md:w-[350px] lg:w-[450px] xl:w-[872px] md:flex items-center gap-3">
    ...
    <div
        x-show="open"
        x-transition
        class="w-full mt-4 space-y-4 md:hidden"
    >
